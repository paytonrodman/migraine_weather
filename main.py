...
from migraine_weather.utils import compile_data, check_file_exists
...
def main(
    ...
    eligible_stations = data_acquisition.get_eligible_stations("hourly", start, end)
    ...
    for country_code, country_stations in eligible_stations.groupby(by="country"):
        ...
        file_exists = check_file_exists(country_code, data_files, overwrite=False)
